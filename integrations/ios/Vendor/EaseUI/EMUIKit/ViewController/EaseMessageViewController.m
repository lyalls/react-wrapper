...
- (void)viewDidLoad {
    ...
    UIButton *backBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 13, 22)];
...
- (NSArray *)formatMessages:(NSArray *)messages
{
    ...
    for (EMMessage *message in messages) {
        ...
        if (_dataSource && [_dataSource respondsToSelector:@selector(messageViewController:modelForMessage:)]) {
            ...
            if ([message.from isEqualToString:@"baocai"]) {
                model.avatarImage = [UIImage imageNamed:@"customServiceHeader.png"];
            } else {
                model.avatarImage = [UIImage imageNamed:@"customServiceMyHeader.png"];
            }
