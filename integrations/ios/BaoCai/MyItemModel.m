...
+ (NSMutableArray *)getDataWithIsHasUnRead:(BOOL)isHasUnRead isHasNewVersion:(BOOL)isHasNewVersion withMyPageDataModel:(MyPageDataModel *)model {
    ...
    model1.iconImage = [UIImage imageNamed:@"myIcon1.png"];
    ...
    model2.iconImage = [UIImage imageNamed:@"myIcon2.png"];
    ...
    model3.iconImage = [UIImage imageNamed:@"myIcon3.png"];
    ...
    model4.iconImage = [UIImage imageNamed:@"myIcon4.png"];
    ...
    model5.iconImage = [UIImage imageNamed:@"myIcon5.png"];
    ...
    model6.iconImage = [UIImage imageNamed:@"myIcon6.png"];
