...
@interface UISettingViewController () <UIGesturePwdDelegate, UMSocialUIDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 6) {
        ...
        UIAboutTableViewController *view = [self getControllerByMainStoryWithIdentifier:@"UIAboutTableViewController"];
