...
-(UIView*)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake((footerView.bounds.size.width - image.size.width)/2, tableView.frame.origin.x + tableView.frame.size.height/2  - image.size.height/*(Screen_height == 480)?40:120*/, image.size.width, image.size.height)];
