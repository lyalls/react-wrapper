//
//  BCMyTransferTransferTableViewCell.m
//  BaoCai
//
...
@interface BCMyTransferTransferTableViewCell ()
...
@implementation BCMyTransferTransferTableViewCell
...
- (void)reloadData:(MyTransferListItemModel *)model {
    ...
    self.changePeriodLabel.text = [NSString stringWithFormat:@"剩余%@期/共%@期", model.changePeriod, model.borrowPeriod];
}
