...
- (void)viewDidLoad
{
    ...
    self.promptLab.textColor = Color999999;
    ...
    [forgotPassBtn setTitleColor:Color999999 forState:UIControlStateNormal];
    ...
    [loginBtn setTitleColor:Color999999 forState:UIControlStateNormal];
